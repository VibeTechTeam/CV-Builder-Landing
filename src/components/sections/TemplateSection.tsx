...
export const TemplateSection = () => {
  ...
  return (
    <section
      ...
      className="relative py-28 bg-black rounded-t-4xl bg-center bg-size-[150%_150%] md:bg-size-[100%_100%]"
    >
      {/* Content */}
      <div className="section-container">
        <div className="flex flex-col md:flex-row gap-x-8 gap-y-20 items-center md:items-start md:justify-between">
          ...
          <div className="flex-1 max-w-[600px] md:text-left sm:text-center text-left">
            {/* Main Heading */}
            <h2 className="text-white font-semibold text-4xl lg:text-6xl leading-tight mb-4 mb:mb-8">
              Create a <span className="text-accent-500">resume</span> that gets
              you <span className="text-accent-500">hired</span>
            </h2>

            {/* Description */}
            <p className="md:w-3/4 text-white font-light text-xl lg:text-2xl leading-relaxed mb-12">

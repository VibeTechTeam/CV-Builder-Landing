    ...
    <div>
        ...
        >
            <div className="flex items-center justify-center md:flex-col lg:flex-row xl:flex-row">
                ...
                <div className="w-image-second h-image-second  relative bottom-36 left-48 md:w-[800px] md:bottom-28 md:left-20 lg:bottom-20 lg:left-9 lg:w-[1000px] xl:bottom-24 xl:left-4 xl:w-[700px]" >
                    <Image className="w-full h-auto object-contain" src={ThirdSectionImage} alt="Third section image" />
                </div>
                {/* <div className="flex flex-col gap-6 relative bottom-48 right-28  md:right-0 lg:bottom-14 lg:right-12 xl:bottom-40 xl:right-36"> */}
                ...
                <div className="flex flex-col gap-6 relative bottom-48 right-28  md:right-0 lg:bottom-14 lg:right-12 xl:bottom-24 xl:right-24">

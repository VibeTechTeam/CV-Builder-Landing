    ...
    <div>
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center sm:flex-col md:flex-col lg:flex-row xl:flex-row">
                ...
                {/* <div className="w-[500px] relative bottom-36 left-48 mobileXS:w-[350px] mobileXS:bottom-7 mobileXS:left-8 xs:bottom-16 xs:left-11 smx:bottom-12 smx:left-10 sm:w-[700px] sm:bottom-18 sm:left-12 md:w-[800px] md:bottom-28 md:left-20 lg:bottom-28 lg:left-9 lg:w-[700px] xl:bottom-24 xl:left-4 xl:w-[700px] xl1440:w-[938px] xl1440:h-[1144px] xl1440:bottom-32 xl1440:left-0 xl1536:w-[1271px]" > */}
                <div className="w-[500px] relative bottom-36 left-48 mobileXS:w-[360px] mobileXS:bottom-7 mobileXS:left-7 xs:bottom-16 xs:left-11 smx:bottom-12 smx:left-10 sm:w-[700px] sm:bottom-18 sm:left-12 md:w-[800px] md:bottom-28 md:left-20 lg:bottom-28 lg:left-9 lg:w-[700px] xl:bottom-24 xl:left-4 xl:w-[700px] xl1440:w-[938px] xl1440:h-[1144px] xl1440:bottom-32 xl1440:left-0 xl1536:w-[1271px]" >
                ...
                {/* <div className="flex flex-col gap-6 relative bottom-48 right-28 mobileXS:bottom-16 mobileXS:right-0 mobileXS:left-4 xs:bottom-28 xs:right-0 xs:left-5 smx:bottom-20 smx:right-0 smx:left-auto sm:bottom-32 sm:right-0 sm:left-auto md:bottom-52 md:right-0 md:left-auto lg:bottom-14 lg:right-12 lg:left-auto xl:bottom-24 xl:right-24 xl:left-auto xl1440:bottom-32 xl1440:w-[555px] xl1440:left-auto xl1536:bottom-38 xl1536:left-auto"> */}
                {/* <div className="flex flex-col gap-6 relative bottom-48 right-28  xs:bottom-28 xs:right-0 xs:left-5 smx:bottom-20 smx:right-0 smx:left-auto sm:bottom-32 sm:right-0 sm:left-auto md:bottom-52 md:right-0 md:left-auto lg:bottom-14 lg:right-12 lg:left-auto xl:bottom-24 xl:right-24 xl:left-auto xl1440:bottom-32 xl1440:w-[555px] xl1440:left-auto xl1536:bottom-38 xl1536:left-auto"> */}
                <div className="flex flex-col gap-6 relative bottom-48 right-28  mobileXS:bottom-16 mobileXS:right-0 mobileXS:left-auto xs:bottom-28 xs:right-0 xs:left-5 smx:bottom-20 smx:right-0 smx:left-auto sm:bottom-32 sm:right-0 sm:left-auto md:bottom-52 md:right-0 md:left-auto lg:bottom-14 lg:right-12 lg:left-auto xl:bottom-24 xl:right-24 xl:left-auto xl1440:bottom-32 xl1440:w-[555px] xl1440:left-auto xl1536:bottom-38 xl1536:left-auto">
                    ...
                    <p className="font-noto-sans font-semibold text-5xl  mobileXS:text-3xl smx:text-4xl lg:text-4xl xl:text-5xl">Unlock Your Advantage<br/>with Foliofy</p>
                    {/*  */}

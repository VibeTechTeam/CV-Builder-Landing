    ...
    <div>
        ...
        >
            ...
            <div className="flex flex-col items-center justify-center sm:flex-col md:flex-col lg:flex-row xl:flex-row">
                {/* <div className="w-[500px] relative bottom-36 left-48 ultraXS:w-[300px] mobileXS:w-[360px] mobileXS:bottom-7 mobileXS:left-7 xs:bottom-16 xs:left-11 smx:bottom-12 smx:left-10 sm:w-[700px] sm:bottom-18 sm:left-12 md:w-[800px] md:bottom-28 md:left-20 lg:bottom-28 lg:left-9 lg:w-[700px] xl:bottom-24 xl:left-4 xl:w-[700px] xl1440:w-[938px] xl1440:h-[1144px] xl1440:bottom-32 xl1440:left-0 xl1536:w-[1271px]" > */}
                <div className="w-[500px] relative bottom-36 left-48 ultraXS:w-[300px] mobileXS:w-[360px] mobileXS:bottom-7 mobileXS:left-7 xs:bottom-16 xs:left-11 smx:bottom-12 smx:left-10 sm:w-[700px] sm:bottom-18 sm:left-12 md:w-[800px] md:bottom-28 md:left-20 lg:bottom-28 lg:left-9 lg:w-[700px] xl:bottom-24 xl:left-4 xl:w-[700px] xl1440:w-[938px] xl1440:h-[1144px] xl1440:bottom-32 xl1440:left-0 xl1536:w-[1271px]" >

export const CVProcessSection = () => {
  ...
  return (
    <section id='features'>
      <div className='flex items-center gap-10 section-container py-[80px]'>
        ...
        <div className='flex flex-col gap-12'>
          {process.map(({ icon, title, description }, idx) => (
            <div
              key={idx}
              className='flex items-center gap-6 p-4 rounded-[32px] hover:shadow-[0px_10px_10px_-5px_rgba(0,0,0,0.04),0px_20px_25px_-5px_rgba(0,0,0,0.1)] transition-shadow duration-300'
            >
